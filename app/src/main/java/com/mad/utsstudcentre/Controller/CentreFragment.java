...
public class CentreFragment extends Fragment {
    ...
    public static final String EST_TIME = "Estimated sTime";
     ...
     * The estimated sTime is calculated out of waiting list. (waiting number * 5 min)
     */
...
//        mEstTime01 = wait01 * 5; // 5 minutes average sTime per booking
